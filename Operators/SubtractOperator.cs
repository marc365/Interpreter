    ...
    public class SubtractOperator : Operator
    {
        ...
        internal override Literal Execute(IConstruct argument1, IConstruct argument2)
        {
            ...
            if (argument1Transformed is Number && argument2Transformed is Number)
                ...
                return (Error)(String.Format("Subtract operator requires arguments of type Number or DateTime. Argument types are {0} {1}.", argument1Transformed.GetType().Name, argument2Transformed.GetType().Name));
        }
